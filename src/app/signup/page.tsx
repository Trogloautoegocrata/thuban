        ...
        <div className="login-card" style={{ maxWidth: 480 }}>
          ...
          <form onSubmit={handleSubmit} className="login-form">
            <div className="form-group">
              ...
              <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Juan Pérez" className="form-input" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="+52 55 1234 5678" className="form-input" />
            </div>
            <div className="form-row-duo">
              ...
              <div className="form-group">
                ...
                <input type="password" value={confirm} onChange={(e) => setConfirm(e.target.value)} placeholder="••••••••" className="form-input" />
              </div>
            </div>
            <label className="checkbox-label" style={{ margin: "0.5rem 0 1rem" }}>
              <input type="checkbox" checked={terms} onChange={(e) => setTerms(e.target.checked)} />
              Acepto los <a href="#" style={{ color: "var(--gold)", textDecoration: "underline" }}>términos y condiciones</a>
            </label>
